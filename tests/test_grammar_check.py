...
from gitresume_core.grammar_check import AIGrammarChecker, LocalGrammarFixer, correct_resume_grammar
...
async def test_correct_resume_grammar(mock_processor, mock_llm):
    ...
    resume_data = {"project_title": "Old Title", "additional_notes": "Old Note", "bullet_points": []}
...
async def test_correct_resume_grammar_interview_questions(mock_processor):
    ...
    resume_data = {"interview_questions": [{"question": "Q1", "answer": "A1"}]}
