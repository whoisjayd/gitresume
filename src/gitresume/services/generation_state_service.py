...
class RedisGenerationStateService:
    ...
    def _state_to_hash(state: GenerationState) -> dict[str, str]:
        return {
            ...
            "analysis_author": state.analysis_author or "",
            "analysis_days": str(state.analysis_days or ""),
            ...
            "owner_scope": state.owner_scope or "",
    ...
    def _state_from_hash(raw: dict[str, str]) -> GenerationState:
        ...
        return GenerationState(
            ...
            analysis_author=raw.get("analysis_author") or None,
            analysis_days=int(raw["analysis_days"]) if raw.get("analysis_days") else None,
            ...
            owner_scope=raw.get("owner_scope") or None,
